      ...
      <div className="mx-auto max-w-7xl px-2 sm:px-4 lg:px-6">
        <div className="relative flex h-14 items-center justify-between">
          <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
            ...
            <button
              type="button"
              className="relative inline-flex items-center justify-center rounded-md p-1.5 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
            ...
            >
              ...
              <svg
                className={`${menuOpen ? 'hidden' : 'block'} h-5 w-5`}
                fill="none"
                viewBox="0 0 24 24"
                strokeWidth="1.5"
                stroke="currentColor"
              ...
              <svg
                className={`${menuOpen ? 'block' : 'hidden'} h-5 w-5`}
                fill="none"
                viewBox="0 0 24 24"
                strokeWidth="1.5"
                stroke="currentColor"
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div className="hidden sm:ml-6 sm:block">
              <div className="flex space-x-3">
                <Link
                  to="/dashboard"
                  className="rounded-md bg-gray-900 px-2 py-1 text-sm font-medium text-white"
                  aria-current="page"
                >
                  Dashboard
                </Link>
